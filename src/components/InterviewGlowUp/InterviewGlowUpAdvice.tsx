...
function Callout({ children, variant = 'default' }: CalloutProps) {
  ...
  return (
    <div className={cn('rounded-xl border p-4 text-foreground', variants[variant])}>{children}</div>
  );
}
  ...
  return (
    <article className="space-y-12 rounded-2xl border border-[hsl(var(--border)/0.5)] bg-[hsl(var(--card)/0.45)] px-6 py-12 sm:px-10 sm:py-14">
      ...
      <div className="flex items-center gap-3 rounded-xl border border-[hsl(var(--foam)/0.3)] bg-[hsl(var(--foam)/0.06)] px-4 py-3 text-sm text-muted-foreground">
        ...
        <span>
          <strong>Privacy first:</strong> No data leaves your browser. Everything is stored locally
          on your device.
        </span>
      </div>
      ...
      <Section title="Why interviews feel hard">
        <Callout variant="insight">
          <p className="font-medium">
            The "exam mindset" is your enemy. When you think "I'm being tested," your brain goes
            into survival mode. You forget details, speak too fast, and struggle to think clearly.
          </p>
        </Callout>
      ...
      <Section title="What recruiters actually want">
        ...
        <Callout variant="default">
          ...
          <ol className="mt-2 list-inside list-decimal space-y-1 pl-2">
            <li>
              <strong>Can you do the job?</strong> (Skills & experience)
            </li>
            <li>
              <strong>Will you do the job?</strong> (Motivation & work ethic)
            </li>
            <li>
              <strong>Will you fit in?</strong> (Culture & collaboration)
            </li>
          </ol>
        </Callout>
      ...
      <Section title="Shift your mindset: conversation over performance">
        <p className="leading-relaxed">
          Stop thinking of interviews as performances. Think of them as{' '}
          <strong>proof-based conversations</strong>. The interviewer asks "Can you solve X?" and
      ...
      <Section title="Decode the job description">
        ...
        <Callout variant="tip">
          ...
          <p className="mt-1 text-sm">
            <strong>Likely question:</strong> "Tell me about a feature you owned from start to
            finish."
          </p>
        </Callout>
        <p className="mt-4 leading-relaxed">
      ...
      <Section title="The Play + Proof method">
        <p className="leading-relaxed">
          For each skill, you need <strong>one strong story</strong>. Structure it with Play +
          Proof:
        </p>
      ...
      <div className="flex flex-col items-center gap-4 rounded-2xl border border-[hsl(var(--love)/0.4)] bg-[hsl(var(--love)/0.07)] px-6 py-8 text-center sm:px-10 sm:py-10">
        ...
        <p className="max-w-lg text-muted-foreground">
          Decode a real job description, create your Play + Proof stories, and generate a
