        ...
        {bullet ? (
          <>
            ...
            {suggestions.length > 0 && (
              <div className="rounded-2xl border border-[hsl(var(--gold)/0.4)] bg-[hsl(var(--gold)/0.08)] p-4">
                <p className="text-xs uppercase tracking-[0.3em] text-[hsl(var(--gold))]">Suggestions</p>
          ...
          <div className="flex flex-col items-center justify-center min-h-[240px] text-center">
            ...
            <p className="text-xs text-muted-foreground max-w-xs">
              Select a bullet from the list on the left to edit its verb, quantifier, task, and impact. Your changes update the score in real time.
            </p>
          </div>
        )}
      </CardContent>
