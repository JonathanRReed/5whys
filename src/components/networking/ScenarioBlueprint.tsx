...
function EmptyState() {
  return (
    <div className="flex flex-col items-center justify-center py-10 text-center">
      ...
      <p className="mt-1 text-sm text-[hsl(var(--muted-foreground))]">Select a scenario above to see the blueprint.</p>
    </div>
  );
}
    ...
    <Card className="border-[hsl(var(--border)/0.6)] bg-[hsl(var(--overlay)/0.28)]">
      ...
      <CardContent className="space-y-6">
        ...
        <div className="rounded-2xl border border-[hsl(var(--border)/0.35)] bg-[hsl(var(--background)/0.6)] p-4">
          <p className="text-xs uppercase tracking-[0.3em] text-[hsl(var(--muted-foreground))]">Practice flow</p>
