...
const FIELDS = [
  {
    ...
    accent: 'gold',
    helpText: "Name or describe the person. Examples: 'VP of Engineering at Stripe', 'Former coworker now at Notion', 'Hiring manager for the PM role'",
  },
  {
    ...
    accent: 'love',
    helpText: "Describe the context. Examples: 'Coffee chat over Zoom', 'Industry conference hallway', 'LinkedIn voice message'",
  },
  {
    field: 'what' as const,
    title: 'WHAT',
    ...
    accent: 'foam',
    helpText: "Your specific goal. Examples: 'Ask about team culture', 'Request referral to hiring manager', 'Learn about their transition from IC to manager'",
  },
] as const;
          ...
          >
            ...
            <CardContent className="pt-0 space-y-2">
              <Textarea
                ...
                className="min-h-[140px] bg-[hsl(var(--overlay)/0.3)] border-[hsl(var(--border)/0.5)] text-sm text-[hsl(var(--foreground))] focus:ring-2 focus:ring-[hsl(var(--foam))] focus-visible:ring-2 focus-visible:ring-[hsl(var(--foam))]"
              />
              <p className="text-xs text-[hsl(var(--muted-foreground))] leading-relaxed">{helpText}</p>
            </CardContent>
          </Card>
        ))
      }
