...
const ACCENTS = ['text-foam', 'text-gold', 'text-love', 'text-iris'] as const;
  ...
  return (
    <Card className="border-border/60 bg-overlay/28">
      <CardHeader className="space-y-2">
        <CardTitle className="text-love">Sample lines</CardTitle>
          ...
          <>
            {ingredients.map((ingredient, index) => {
              ...
              return (
                <div
                  key={ingredient.id}
                  className="rounded-2xl border border-border/35 bg-background/60 p-4"
                >
                  <div className="flex items-start gap-3">
                    <div className="flex-1">
                      ...
                      <p className="mt-2 text-sm text-foreground">{ingredient.line}</p>
                    </div>
                    <Button
                      type="button"
                      size="sm"
