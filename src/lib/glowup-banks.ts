...
export const SKILL_BANK: Skill[] = [
  ...
  },
  {
    ...
    name: 'SQL/Databases',
    category: 'technical',
    keywords: ['sql', 'mysql', 'postgresql', 'database', 'mongodb', 'redis', 'nosql'],
  },
  {
    id: 'cloud',
  ...
  },
  {
    ...
    name: 'API Design',
    category: 'technical',
    keywords: ['api', 'rest', 'graphql', 'grpc', 'microservices', 'integration'],
  },
  {
    id: 'frontend',
  ...
  },
  {
    ...
    name: 'Leadership',
    category: 'soft',
    keywords: ['leadership', 'lead', 'manage', 'mentor', 'coach', 'influence', 'vision'],
  },
  {
    id: 'teamwork',
    name: 'Teamwork',
    category: 'soft',
    keywords: ['teamwork', 'team', 'collaborate', 'cross-functional', 'partner'],
  },
  {
    id: 'problem-solving',
  ...
  },
  {
    ...
    category: 'soft',
    keywords: ['time management', 'prioritize', 'deadline', 'multitask', 'organize'],
  },
  {
    id: 'ownership',
...
export function getQuestionsForSkill(skillId: string): QuestionPrompt[] {
  return QUESTION_BANK.filter(
    (q) => q.skillIds.includes(skillId) || q.skillIds.includes('general')
  );
}
